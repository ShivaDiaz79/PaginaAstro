  ...
  <Link href={href}>
    ...
    >
      <img
        ...
        alt=""
      />
      <h2 className="text-center font-bold absolute inset-0 flex items-center justify-center text-white">
        {title}
      </h2>
    </div>
  </Link>

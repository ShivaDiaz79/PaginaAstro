...
const Mockupcolors = () => {
  return ( 
    <div className="transform hover:scale-110 transition-transform duration-300 ease-in-out mx-auto my-auto">
    <div className="relative mx-auto border-gray-300 dark:border-gray-800 bg-gray-300 dark:bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] sm:m-32">
      ...
      <div className="rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white dark:bg-gray-800">
        <img
          src="https://res.cloudinary.com/di1v23yy0/image/upload/v1694212383/desarrollo-sitios-web-multiplataforma-aplicaciones-moviles-portatiles-ia-generativa_914455-3362_wfuupp.avif"

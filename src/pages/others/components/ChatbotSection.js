...
const ChatbotSection = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap">
    <div className="flex flex-wrap w-full">
      ...
      <img className="lg:w-3/5 md:w-1/2 object-cover object-center rounded-lg md:mt-0 mt-12" src="https://res.cloudinary.com/di1v23yy0/image/upload/v1694212381/concepto-tecnologia-inteligencia-artificial-ai_43780-4308_b5fvnz.avif" alt="step"/>
    </div>
  </div>
</section>
    </div>
